  ...
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center px-1">
      ...
      <button
        ...
        class="flex items-center m-3 text-xs py-1 px-2 rounded-sm text-red-400 hover:bg-gray-700"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
  ...
  <div class="grid grid-cols-12 gap-3">
    ...
    <div class="mt-3 col-span-9">
      ...
      <input
        ...
        @change="deleteChange"
        class=" block w-full py-2 px-3 border border-gray-400 rounded-md sm:text-sm mt-1"
      />
    </div>
    <!-- /question -->
    ...
    <div class="mt-3 col-span-3">
      ...
      <select
        ...
        v-model="model.type"
        @change="typeChange"
        class="mt-1 block w-full px-3 py-2 border border-gray-400 rounded-md sm:text-sm"
      >
