    ...
    <div class="flex items-center justify-between mt-3">
      ...
      <div class="flex items-center">
        ...
        <button
          ...
          class="h-8 w-8 flex items-center justify-center rounded-full cursor-pointer border border-transparent text-sm text-red-500 focus:ring-2 focus:ring-offset-0 focus:ring-red-500"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
